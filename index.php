...
$(document).ready(function() {
	...
	$("#shout_message").keypress(function(evt) {
		 if($("#shout_username").val().length == 0 ){
				alert("Ingrese su nombre");
		 }
		 if($("#shout_username").val().length <7){
...
<body>
<iframe width="420" height="315" src="//www.youtube.com/embed/OL675-hvL_g" frameborder="0" allowfullscreen></iframe>
<div class="shout_box">
<div class="header">Chat<div class="close_btn">&nbsp;</div></div>
  ...
  <div class="message_box">
   ...
   <input name="shout_message" id="shout_message" type="text" placeholder="Tu comentario" maxlength="100" /> 
    </div>
    </div>
</div>
</body>
